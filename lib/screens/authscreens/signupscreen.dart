...
List<String> role = ["Select Role", "public-user", "professional"];
AuthBloc? _authBloc;
String selectedGender = "";
String? toDateInString;
DateTime? toDate;
bool? istoDateSelected;
String dropdownValuegender = "Select Gender";
String dropdownValuerole = "Select Role";
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(color: Colors.cyan), // Set border color here
                      ),
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(25),
                        borderSide: BorderSide(color: Colors.cyan), // Set focused border color here
                      ),
                      filled: true,
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items:
                            role.map<DropdownMenuItem<String>>((String value) {
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Container(
                              width: 200, // Set the width of each dropdown item
...
Future _signUp(
  ...
  body["age"] = age;
  body["gender"] = dropdownValuegender;
