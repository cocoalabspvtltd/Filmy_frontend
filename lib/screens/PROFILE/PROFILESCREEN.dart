...
class _ProfilePageState extends State<ProfilePage> {
  List<String> inntrest = ["Select Intrest", "Dubbing", "Cinematography","vfx","production","scripting"];
  ...
  void _fetchJuryMembers() async {
    ...
    final response = await http.get(Uri.parse('https://07f1-117-221-145-221.ngrok-free.app/api/users/skills-list'),
        headers: headers
    );
  ...
  Future<void> _uploadImage(File imageFile) async {
    final uri = Uri.parse('https://07f1-117-221-145-221.ngrok-free.app/api/users/update_profile_picture');
  ...
  Widget build(BuildContext context) {
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Text("Profile"),
            Spacer(),
            GestureDetector(onTap: (){Get.to(Gallery());},
                child: Text("gallery"))
          ],
        ),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextField(controller: skillControl,
                      decoration: InputDecoration(
                        border: OutlineInputBorder(),
    ...
    decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),  color: Colors.white,),
    child: TextField(controller: profControl,
    decoration: InputDecoration(
    border: OutlineInputBorder(),
    ...
    print('The entered text is: $value');
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextField(controller: experControl,
                      decoration: InputDecoration(
                        border: OutlineInputBorder(),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: MultiSelectDialogField<Skills>(
                      items: Skillsmulti
                          .map((member) => MultiSelectItem<Skills>(member, member.name.toString()))
                          .toList(),
                    ...
                    children: <Widget>[
                      ...
                      Container(height: 40,width: 270,
                        child: ElevatedButton(
                          style: ButtonStyle(
                            backgroundColor: MaterialStateProperty.all<Color>(Colors.blue), // Set the background color of the ElevatedButton
                          ),
                 ...
                 //
                   Padding(
                     ...
                     child: Container(
                            ...
                            await _addPropertyFun(_filePath,skillControl.text,addressControl.text,experControl.text,profControl.text,selectedOptionsIds);
                                  },
  ...
  _addPropertyFun(
    ...
    await _authBloc.addProperty(image!, interests, address, years,profesion,ids,);
  }
